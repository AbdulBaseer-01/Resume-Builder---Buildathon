...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // Avoid `any` cast — THREE.SRGBColorSpace is available in three ≥ r152
    if ('SRGBColorSpace' in THREE) {
      renderer.outputColorSpace = (THREE as typeof THREE & { SRGBColorSpace: string }).SRGBColorSpace;
    }
  ...
  // Sync all prop changes to uniforms without restarting the GL context
  useEffect(() => {
    ...
    (material.uniforms.uColors.value as THREE.Vector3[]).forEach((vec, i) => {
